...
- หน้าเริ่มต้นของ GitHub Pages ใช้ [index.html](/Users/9phoomphi/Desktop/ระบบทะเบียนคุมลูกหนี้เงินบำรุง/index.html) และจะ redirect ไป [Dashboard.html](/Users/9phoomphi/Desktop/ระบบทะเบียนคุมลูกหนี้เงินบำรุง/Dashboard.html) ให้อัตโนมัติ
...
- มีไฟล์ [.nojekyll](/Users/9phoomphi/Desktop/ระบบทะเบียนคุมลูกหนี้เงินบำรุง/.nojekyll) เพื่อให้ GitHub Pages เสิร์ฟไฟล์ static ตรง ๆ

วิธีใช้งานบน GitHub Pages:

1. Deploy Apps Script เป็น Web App เวอร์ชันล่าสุด
2. อัปโหลดไฟล์ทั้งหมดขึ้น GitHub Pages รวม [index.html](/Users/9phoomphi/Desktop/ระบบทะเบียนคุมลูกหนี้เงินบำรุง/index.html) และ [.nojekyll](/Users/9phoomphi/Desktop/ระบบทะเบียนคุมลูกหนี้เงินบำรุง/.nojekyll)
3. เปิดใช้หน้าเว็บจาก root ของ GitHub Pages ได้เลย เช่น `https://<user>.github.io/<repo>/`
4. ถ้าต้องการเปิดตรงหน้าเดิมก็ยังใช้ [Dashboard.html](/Users/9phoomphi/Desktop/ระบบทะเบียนคุมลูกหนี้เงินบำรุง/Dashboard.html) ได้
5. เปิดไฟล์ [config.js](/Users/9phoomphi/Desktop/ระบบทะเบียนคุมลูกหนี้เงินบำรุง/config.js)
6. เปลี่ยนค่า `apiBase` ให้เป็นลิงก์จริงรูปแบบ `https://script.google.com/macros/s/.../exec`
7. ระบบจะอ่านค่า `apiBase` จาก `config.js` อัตโนมัติในทุกหน้า
8. ถ้าไฟล์ `config.js` โหลดไม่สำเร็จจริง ระบบค่อย fallback ไปถามผู้ใช้และจำค่าไว้ใน browser

หมายเหตุสำคัญ:

- ถ้าคุณเปิด `https://github.com/...` นั่นคือหน้า repo ของ GitHub และ GitHub จะโชว์ `README.md`
- ถ้าคุณเปิด `https://<user>.github.io/...` นั่นคือหน้า GitHub Pages ของเว็บ
- สำหรับ GitHub Pages หน้าแรกควรเป็น `index.html` จึงเหมาะที่สุดที่จะให้ root ของเว็บเปิดเข้า Dashboard อัตโนมัติ
